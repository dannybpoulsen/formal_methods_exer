...
# Exercise 1
Implement the algorithm for converting a Whiley-program to a CFA it. To do this, you will need
...
- The skeleton solution already implements the CFA-structure for you. You  can see the interface of the CFA in the .hpp file in "lib/ir/include/"
- 
